...
const faqs: FAQItem[] = [
  {
    id: 'eligibility',
    question: 'لمن صُمم مشروع ارث و اثر',
    answer: 'صُمّم مشروع "ارث واثْر" خصيصاً للشباب الجزائري الطموح الذي تتراوح أعماره بين 18 و 35 سنة، ويحمل في قلبه شغفاً تجاه اكتشاف كنوز الجزائر التاريخية والثقافية العميقة. المشروع مفتوح للشباب من مختلف التخصصات والخلفيات، شريطة أن يكون لديه دافع حقيقي لتعميق فهمه للهوية الجزائرية والمساهمة في إحيائها وتوثيقها، سواء كان طالباً، خريجاً، ناشطاً جمعوياً، أو مبادراً يسعى لتطوير قدراته في صناعة المحتوى الثقافي والتراثي.'
  },
  {
    id: 'content',
    question: 'ما هي الورشات التي سنشارك فيها؟',
    answer:
      'ستُقام ورشات تفاعلية تطبيقية، يشارك فيها ضيوف وخبراء في مجال صناعة المحتوى والتراث، بهدف صقل مهاراتكم وتزويدكم بالأدوات اللازمة لتحويل شغفكم إلى محتوى هادف ومؤثر، قادر على إحياء الذاكرة الجماعية وتعزيز الشعور بالانتماء للجزائر.',
  },
  {
    id: 'duration',
    question: 'متى سيتم الإعلان عن موعد البرنامج؟',
    answer:
      'سيتم الإعلان عن موعد البرنامج قريباً عبر جميع القنوات الرسمية للمشروع، لذا ندعوكم لمتابعتنا عن كثب للاطلاع على كافة التفاصيل والتحديثات.',
  },
  {
    id: 'certificate',
